...
//        }
        ...
        posPrinterBuilder.setText("------------------------------------------------\n");
        posPrinterBuilder.chooseFont(2);
        if(retailPrintDTO.getSiData().getTotalCheckOutamt()>0 && StringUtils.isEmpty(retailPrintDTO.getSiData().getAirPayId()) && StringUtils.isEmpty(retailPrintDTO.getSiData().getOlInvPayId())) {
