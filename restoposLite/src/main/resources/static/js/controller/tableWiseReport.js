...
app.controller('tableWiseReportcontroller', function ($scope, $http, $rootScope, Notification) {
    ...
    $http.get("/reports/invoice/onLoadPageData").then(function (data) {
        ...
        $scope.tableList = data.data.tableList;
    ...
    $scope.getTablesList = function () {
        $http.post($scope.hiposServerURL + "/getTableNmList").then(function (response) {
            var data = response.data;
            $scope.tablesActiveList = data;
        });
    }
    $scope.getTablesList();
    ...
    $scope.onPageLoadData = function (searchText) {
        ...
        $http.get("/reports/restaurantInvoicePaymentList", {
            params: {
    ...
    $scope.getPaginatedSalesInvoice = function (page, SIfilter) {
        ...
        if (!$scope.isFilterApplied) {
            ...
            $http.get("/reports/restaurantInvoicePaymentList?table="+$scope.table, {
                params: {
                    "fromDate": $scope.fromDate,
                    "toDate": $scope.toDate,
