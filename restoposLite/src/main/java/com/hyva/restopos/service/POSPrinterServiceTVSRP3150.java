...
@Service("TVSRP3150")
@Qualifier("TVSRP3150")
public class POSPrinterServiceTVSRP3150 implements BasePosPrinterService {
...
//            posPrinterBuilder.setText("GSTIN: " + customer.getGstCode());
    ...
    public Map formatAndPrintBill(RetailPrintDTO retailPrintDTO) {
        ...
        if(!accountSetup.isCopytokot()) {
            if(!StringUtils.isEmpty(retailPrintDTO.getSiData().getEmployeeName())) {
                if(StringUtils.pathEquals(printerSelectionDisplayPojo.getSteward(),"Yes")) {
...
//        }
        ...
        for (SelectedItem item : retailPrintDTO.getSiData().getSelectedItemsList()) {
            posPrinterBuilder.setText(""
                    + String.format("%-18s", String.valueOf(item.getItemName()).substring(0,Math.min(item.getItemName().length(),17)).toUpperCase()) + ""
            ...
            if(item.getItemName().length()>17){
                posPrinterBuilder.setText(""
                        + String.format("%-18s", String.valueOf(item.getItemName()).substring(18,Math.min(item.getItemName().length(),41)).toUpperCase()) + ""
                        + "\n");
            }
            posPrinterBuilder.alignCenter();
        ...
        posPrinterBuilder.setText("-----------------------------------------");
        posPrinterBuilder.newLine();
        posPrinterBuilder.setText("Net Total :                    " + String.format("%10s", String.format("%.02f", sumAmtExclusiveTax-discountValue)) + "\n");
        ...
        posPrinterBuilder.setText("-----------------------------------------\n");
        posPrinterBuilder.chooseFont(11);
        posPrinterBuilder.setText(" Grand Total:                       " + String.format("%6s", String.format("%.02f", retailPrintDTO.getSiData().getTotalCheckOutamt())) + "\n");
        posPrinterBuilder.chooseFont(1);
        posPrinterBuilder.setText("-------------------------------------------------------\n");
        posPrinterBuilder.chooseFont(2);
        ...
        if(cashPayment!=null && cashPayment.getTotalCPAmountTendered() > 0){
            posPrinterBuilder.setText("Cash:"+String.format("%38s", String.format("%.02f", cashPayment.getTotalCPAmountTendered())+"\n"));
        }
        ...
        if(bankPayment!=null && bankPayment.getTotalBPAmountTendered() > 0){
            ...
            for(MultiBankPayment multiBankPayment:multiBankPaymentLst){
                posPrinterBuilder.setText(multiBankPayment.getPaymentName()+":"+String.format("%38s", String.format("%.02f", multiBankPayment.getAmount())+"\n"));
...
//                posPrinterBuilder.setText("Amount : "+multiBankPayment.getAmount()+"\n");
        ...
        if(creditCardPayment!=null && creditCardPayment.getTotalCCPAmountTendered() > 0){
            ...
            for(MultiCardPayment multiCardPayment:multiCardPaymentLst){
                posPrinterBuilder.setText(multiCardPayment.getPaymentName()+":"+String.format("%38s", String.format("%.02f", multiCardPayment.getCardAmt())+"\n"));
...
//                posPrinterBuilder.setText("Card Amt : "+multiCardPayment.getCardAmt()+"\n");
        ...
        if(voucherPayment!=null && voucherPayment.getTotalVPAmountTendered() > 0){
            posPrinterBuilder.newLine();
            posPrinterBuilder.setText("Voucher Discount: "+String.format("%25s", String.format("%.02f",voucherPayment.getTotalVPAmountTendered())+"\n"));
...
//            }
    ...
    public Map formatAndPrintBillSI(RetailPrintDTO retailPrintDTO) {
        ...
        for (SelectedItem item : retailPrintDTO.getSiData().getSelectedItemsList()) {
            posPrinterBuilder.setText(""
                    + String.format("%-21s", String.valueOf(item.getItemName()).substring(0,Math.min(item.getItemName().length(),23)).toUpperCase()) + ""
                    + String.format("%8s", String.format("%.02f", item.getUnitPrice())) + ""
                    + String.format("%8s", String.format("%.02f", item.getQty())) + ""
                    + String.format("%16s", String.format("%.02f", item.getUnitPrice()*item.getQty())) + ""
                    + "\n");
            sumAmtExclusiveTax +=item.getUnitPrice()*item.getQty();
        }
        double discountValue=0;
        ...
        //Max length of String '57'
        if(cashPayment!=null && cashPayment.getTotalCPAmountTendered() > 0){
            posPrinterBuilder.setText("Cash:"+String.format("%52s", String.format("%.02f", cashPayment.getTotalCPAmountTendered())+"\n\n"));
        }

        if(bankPayment!=null && bankPayment.getMultiBankPaymentList().size() > 0){
            posPrinterBuilder.newLine();
            posPrinterBuilder.setText(bankPayment.getPaymentType()+":"+String.format("%50s", String.format("%.02f", bankPayment.getTotalBPAmountTendered())+"\n"));
            List<MultiBankPayment> multiBankPaymentLst = bankPayment.getMultiBankPaymentList();
            for(MultiBankPayment multiBankPayment:multiBankPaymentLst){
                if(!StringUtils.isEmpty(multiBankPayment.getBankName()))
                    posPrinterBuilder.setText("Bank Name : "+multiBankPayment.getBankName()+"\n");
        ...
        if(creditCardPayment!=null && creditCardPayment.getCardPaymentList().size() > 0){
            posPrinterBuilder.newLine();
            posPrinterBuilder.setText(creditCardPayment.getPaymentType()+":"+String.format("%50s", String.format("%.02f", creditCardPayment.getTotalCCPAmountTendered())+"\n"));
            List<MultiCardPayment> multiCardPaymentLst = creditCardPayment.getCardPaymentList();
            for(MultiCardPayment multiCardPayment:multiCardPaymentLst){
                if(!StringUtils.isEmpty(multiCardPayment.getCardNo()))
                    posPrinterBuilder.setText("Card No   : "+multiCardPayment.getCardNo()+"\n");
        ...
        if(voucherPayment!=null && voucherPayment.getMultiVoucherPayments().size() > 0){
            posPrinterBuilder.newLine();
            posPrinterBuilder.setText("Voucher Discount: "+String.format("%38s", String.format("%.02f",voucherPayment.getTotalVPAmountTendered())+"\n"));
            for(MultiVoucherPayment multiVoucherPayment:voucherPayment.getMultiVoucherPayments()){
                if (!StringUtils.isEmpty(multiVoucherPayment.getVoucherNo())) {
                    posPrinterBuilder.setText("Voucher No   : " + multiVoucherPayment.getVoucherNo() + "\n");
                }
        ...
        if( retailPrintDTO.getSiData().getTotalTenderedAmount()-retailPrintDTO.getSiData().getTotalCheckOutamt()>0)
            posPrinterBuilder.setText("Amount Returned:  "+String.format("%45s", String.format("%.02f", retailPrintDTO.getSiData().getTotalTenderedAmount()-retailPrintDTO.getSiData().getTotalCheckOutamt())+"\n\n"));
        if( retailPrintDTO.getSiData().getTotalCheckOutamt()-retailPrintDTO.getSiData().getTotalTenderedAmount()>0)
            posPrinterBuilder.setText("Balance Amount:"+String.format("%43s", String.format("%.02f", retailPrintDTO.getSiData().getTotalCheckOutamt()-retailPrintDTO.getSiData().getTotalTenderedAmount())+"\n\n"));
        posPrinterBuilder.setText("--------------------------------------------------------\n");
        if(retailPrintDTO.getSiData().getTotalTaxAmt()>0) {
            ...
            for (TaxSummary taxSummary : retailPrintDTO.getSiData().getTaxWiseSummaryList()) {
                posPrinterBuilder.setText(""
                        ...
                        + String.format("%7s", String.format("%.02f", taxSummary.getTaxPercent() / 2)) + ""
                        + String.format("%10s", String.format("%.02f", taxSummary.getTaxPercent() / 2)) + ""
                        + String.format("%13s", String.format("%.02f", taxSummary.getTaxAmount())) + ""
                        + "\n");
            ...
            posPrinterBuilder.setText(""
                    ...
                    + String.format("%7s", String.format("%.02f", taxPer / 2)) + ""
                    + String.format("%10s", String.format("%.02f", taxPer / 2)) + ""
                    + String.format("%13s", String.format("%.02f", retailPrintDTO.getSiData().getTotalTaxAmt())) + ""
                    + "\n");
        }
        posPrinterBuilder.newLine();
        posPrinterBuilder.alignCenter();
...
//            InventoryLocation inv = hiposDAO.getInvLocObj(Long.parseLong(location));
//            company.se(inv.getInventoryLocationName());
//        }
        cloudPrinterConf = new HashMap<>();
...
//                    posPrinterBuilder.setText("Punched By :" + waiterName + "\n");
    ...
    public Map formatAndPrintCustomerBill(String jsonString) {
        ...
        try {
            ...
            Customer customer=hiposService.getCustomerObject(Long.valueOf(jsonObject.getString("customerId")));

            if(!StringUtils.isEmpty(customer.getTelephone())&& StringUtils.pathEquals(printerSelectionDisplayPojo.getCustomerPhone(),"Yes")) {
...
//            }
            ...
            for (SelectedItem item : itemList) {
                posPrinterBuilder.setText(String.format("%-18s", String.valueOf(item.getItemName().substring(0,Math.min(item.getItemName().length(),17)))) + ""
                        + String.format("%-9s", String.format("%.02f", item.getUnitPrice())) + ""
                        + String.format("%-4s", String.format("%.02f", item.getQty())) + ""
                        + String.format("%10s", String.format("%.02f", item.getUnitPrice()*item.getQty())) + ""
                        + "\n");
...
//            }
            ...
            posPrinterBuilder.chooseFont(11);
            posPrinterBuilder.newLine();
            posPrinterBuilder.setText("Grand Total:                 " + String.format("%11s", String.format("%.02f", Double.parseDouble(jsonObject.getString("grandtotal"))+roundOffValue)) + "\n");
            posPrinterBuilder.setText("-----------------------------------------");
            posPrinterBuilder.newLine();
            posPrinterBuilder.alignCenter();
            if(!StringUtils.isEmpty(printerSelectionDisplayPojo.getFooterText())) {
