...
public class AirPayDetailsPojo {
    private Long airPayId;
    ...
    public Long getAirPayId() {
        return airPayId;
    }

    public void setAirPayId(Long airPayId) {
    ...
    public void setCardUniqueCode(String cardUniqueCode) {
        this.cardUniqueCode = cardUniqueCode;
    }
