...
import com.hyva.restopos.rest.Mapper.OnlineInvoiceMapper;
...
public class HiposController extends HttpServlet {
    ...
    @Autowired
    InvoiceOnlineRepository onlineRepository;

    @RequestMapping(value = "/saveCountry",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity saveCountry(@RequestBody CountryPojo countryPojo)throws Exception{
...
//    }
    ...
    @RequestMapping(value = "/saveDeliveryArea",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity saveDeliveryArea(@RequestBody DeliveryAreaPojo deliveryAreaPojo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.saveDeliveryArea(deliveryAreaPojo));
    }
    @RequestMapping(value = "/saveEmployee",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity saveEmployee(@RequestBody EmployeePojo employeePojo) throws Exception{
    ...
    public ResponseEntity savePaymentmethod(@RequestBody PaymentMethodDTO paymentMethodDTO)throws Exception{
        return ResponseEntity.status(200).body(hiposService.savePaymentmethod(paymentMethodDTO));
    }

    @RequestMapping(value = "/saveDiscountmethod",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity saveDiscountmethod(@RequestBody DiscountPojo discountPojo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.saveDiscountmethod(discountPojo));
    }

    @RequestMapping(value = "/saveState",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity saveState(@RequestBody StatePojo statePojo)throws Exception{
    ...
    public ResponseEntity saveCity(@RequestBody CityPojo cityPojo)throws Exception{
    ...
    @RequestMapping(value = "/getPaymentMethodList",method = RequestMethod.GET,produces = "application/json")
    public ResponseEntity getPaymentMethodList(){
        return ResponseEntity.status(200).body(hiposService.getPaymentMethodList());
    }

    @RequestMapping(value = "/getDiscountMethodList",method = RequestMethod.GET,produces = "application/json")
    public ResponseEntity getDiscountMethodList(){
        return ResponseEntity.status(200).body(hiposService.getDiscountMethodList());
    }
    ...
    @RequestMapping(value = "/getAllStateList",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity getAllStateList()throws Exception{
        return ResponseEntity.status(200).body(hiposService.getAllStateList());
    }
    @RequestMapping(value = "/getAllStaffList",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity getAllStaffList()throws Exception{
        return ResponseEntity.status(200).body(hiposService.getAllStaffList());
    }
    @RequestMapping(value = "/getAllCityList",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity getAllCityList()throws Exception{
        return ResponseEntity.status(200).body(hiposService.getAllCityList());
    }
    @RequestMapping(value = "/getAllZoneList",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity getAllZoneList()throws Exception{
        return ResponseEntity.status(200).body(hiposService.getAllZoneList());
    }
    ...
    public ResponseEntity getAllCategoryList()throws Exception{
        return ResponseEntity.status(200).body(hiposService.getAllCategoryList());
    }
    @RequestMapping(value = "/getAllShiftList",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity getAllShiftList()throws Exception{
        return ResponseEntity.status(200).body(hiposService.getAllShiftList());
    }
    ...
    @RequestMapping(value = "/getKitchenList",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity getKitchenList(){
        return ResponseEntity.status(200).body(hiposService.getKitchenList());
    }
    ...
    public ResponseEntity saveShift(@RequestBody ShiftPojo shiftPojo)throws Exception{
        return ResponseEntity.status(200).body(hiposService.saveShift(shiftPojo));
    }
    @RequestMapping(value = "/getTablesListSpecialRequests",method = RequestMethod.POST,produces="application/json")
    public ResponseEntity getTablesListSpecialRequests(@RequestParam(value="id")Long id){
        return ResponseEntity.status(200).body(hiposService.getTablesListSpecialRequests(id));
    }
...
//    }
    ...
    public ResponseEntity saveNewItemCategory(@RequestBody CategoryPojo categoryPojo)throws Exception {
        return ResponseEntity.status(200).body(hiposService.saveNewItemCategory(categoryPojo));
    }

    @RequestMapping(value = "/saveStaffGroup",method = RequestMethod.POST,produces = "application/json",consumes = "application/json")
    public ResponseEntity saveStaffGroup(@RequestBody StaffGroupPojo staffGroupPojo)throws Exception{
        return ResponseEntity.status(200).body(hiposService.saveStaffGroup(staffGroupPojo));
    }
    ...
    public ResponseEntity getKitchenOrders(@RequestParam(value="waiterName",required = false) String waiterName,
                                           ...
                                           @RequestAttribute(value = "fullName")String name){
        ...
        UserAccountSetup userAccountSetup = userAccountSetupRepository.findAllByFullName(name);
        ...
        if(requestFrom.equals("kitchen")){
           mapList = restaurantTokenRecordRepository.findByProductStatus(productStatusKitchen,date,new Date());
            ...
            if(StringUtils.isEmpty(waiterName)) {
                mapList = restaurantTokenRecordRepository.findBy(productStatusWaiter, date, new Date());
            }else {
        ...
        for(Map map:mapList){
            ...
            mapList1 = gson.fromJson(map.get("tokenItemDetailsList").toString(),type);
            for (Map m:mapList1){
                if(StringUtils.equals(m.get("status").toString(),"Order")){
                    if(userAccountSetup.isKitchenflag()==true){
                        Item item = itemRespository.findAllByItemName(m.get("itemName").toString());
                        if(StringUtils.equals(item.getIdItemCategory().toString(),userAccountSetup.getKitchenId().toString())){
                            map1.put("tokenNo",map.get("tokenNo").toString());
                            map1.put("tableName",map.get("tableName").toString());
                            map1.put("waiter", map.get("waiter").toString());
                            map1.put("kitchenTokenStart", map.get("kitchenTokenStart").toString());
                            map1.put("itemName", m.get("itemName").toString());
                            if(map.get("orderNo")!=null) {
                                map1.put("orderNo", map.get("orderNo").toString());
                            }
                            map1.put("qtyCompleted", m.get("qtyOrdered").toString());
                            itemsList.add(map1);
                        }
                    }else {
                        map1.put("tokenNo",map.get("tokenNo").toString());
        ...
        map.put("kitchenList",gson.toJson(mapList));
        map.put("itemsList",gson.toJson(itemsList));
    ...
    public ResponseEntity placeOrderNotification(@RequestParam("currTableName") String currTableName,
        ...
        Customer customer=  customerRepository.findByFirstName(customerName);
        if(customer==null){
            CustomerPojo customerAccountMasterDTO=new CustomerPojo();
            customerAccountMasterDTO.setTelephone(customerNo);
            customerAccountMasterDTO.setFirst_name(customerName);
...
//            customerAccountMasterDTO.setCurrency(company.getCurrencyId().getCurrencyId().toString());
        ...
        customer=  customerRepository.findByFirstName(customerName);
        Gson gson=new Gson();
    ...
    public ResponseEntity getPaginatedCategoryList(@RequestParam(value = "type", required = false) String type,
                                                   ...
                                                   @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getPaginatedCategoryList(type, searchText,pageNo));
    }

    @RequestMapping(value = "/getPaginationStaffGroupList", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity getPaginationStaffGroupList(@RequestParam(value = "type", required = false) String type,
                                                   @RequestParam(value = "searchText", required = false) String searchText,
                                                   @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getPaginationStaffGroupList(type, searchText,pageNo));
    }

    @RequestMapping(value = "/getPaginatedDiscountList", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity getPaginatedDiscountList(@RequestParam(value = "type", required = false) String type,
                                                   @RequestParam(value = "searchText", required = false) String searchText,
                                                   @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getPaginatedDiscountList(type, searchText,pageNo));
    }

    @RequestMapping(value = "/getPaginatedCityList", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity getPaginatedCityList(@RequestParam(value = "type", required = false) String type,
                                               @RequestParam(value = "searchText", required = false) String searchText,
                                               @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getPaginatedCityList(type, searchText,pageNo));
    }
    ...
    public ResponseEntity getPaginatedVoucherList(@RequestParam(value = "type", required = false) String type,
                                                  @RequestParam(value = "searchText", required = false) String searchText,
                                                  @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getPaginatedVoucherList(type,searchText,pageNo));
    }
...
//                                            @RequestParam(value = "searchText", required = false) String searchText,
//                                            @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
//        return ResponseEntity.status(200).body(hiposService.getPaginatedState(type, searchText,pageNo));
//    }
    ...
    public ResponseEntity getPaginatedAgentList(@RequestParam(value = "type", required = false) String type,
                                                @RequestParam(value = "searchText", required = false) String searchText,
                                                @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getPaginatedAgentList(type,searchText,pageNo));
    }
    ...
    public ResponseEntity getpaginatedcountry(@RequestParam(value = "type", required = false) String type,
                                              @RequestParam(value = "searchText", required = false) String searchText,
                                              @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getcountrypagelist(type, searchText,pageNo));
    }

    @RequestMapping(value = "/getPaginatedDeliveryAreaList", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity getPaginatedDeliveryAreaList(@RequestParam(value = "type", required = false) String type,
                                                   @RequestParam(value = "searchText", required = false) String searchText,
                                                   @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getPaginatedDeliveryAreaList(type, searchText,pageNo));
    }
    ...
    public ResponseEntity getPaginatedCurrencyList(@RequestParam(value = "type", required = false) String type,
                                                   @RequestParam(value = "searchText", required = false) String searchText,
                                                   @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception {
        return ResponseEntity.status(200).body(hiposService.getPaginatedCurrencyList(type, searchText,pageNo));
    }
    ...
    public ResponseEntity saveNewItem(@RequestBody ItemPojo itemPojo ) throws Exception {
     return ResponseEntity.status(200).body(hiposService.createSaveNewItemDetails(itemPojo));
    }
    ...
    public ResponseEntity saveTablesPos(@RequestBody TablesPosPojo tablesPosPojo) throws Exception{
    ...
    public ResponseEntity saveTableConfig(@RequestBody TableConfigPojo tableConfigPojo) throws Exception{
    ...
    public ResponseEntity createOnlinePayment(@RequestParam(value = "payStatus")String paystatus,
        ...
        String ref=String.format("%04d", ++incValue);
        String invoiceNo = company.getConnectNo()+"INV" + ref;//will be changed kundan will send restaurantId and locId need to merge with that string and InvNo
        //String invoiceNo = "15651wqnmI";
        PaymentMethod paymentMethod = paymentMethodRepository.findByPaymentmethodType("invoicePay");
        Gson json = new Gson();
        InvoiceOnline invOl= onlineRepository.findByInvoiceno(invoiceNo);

        if(StringUtils.equalsIgnoreCase("Re-Initiate",paystatus) && invOl !=null){
            ...
            for(SelectedItem selectedItem:retailDTO.getSelectedItemsList()){
                ...
                invoicePOJO.setITEM_DESCRIPTION(selectedItem.itemName + selectedItem.getItemDescription());
            ...
            if(response!=null) {
                ...
                if (StringUtils.equalsIgnoreCase(responseMap.get("success").toString(), "true")) {
                    InvoiceOnline invoiceOnline = new InvoiceOnline();
                    invoiceOnline.setInvoiceno(invoiceNo);
                    invoiceOnline.setStatus("Success");
                    onlineRepository.save(invoiceOnline);
                    invoicePayDetails = getOnlineInvDetails(invoiceNo);
                    ...
                    invoicePayDetails.setMessage("FAIL");

                }
            }
        }
        InvoicePayDetailsPojo invoicePayDetailsPojo = OnlineInvoiceMapper.MapOLINVEntitytoPOJO(invoicePayDetails);
        return ResponseEntity.status(200).body(invoicePayDetailsPojo);
    ...
    public InvoicePayDetails getOnlineInvDetails(String orderId)throws Exception {
        if(timelimit ==0){
            t1 = System.currentTimeMillis() +300000;
            timelimit =timelimit + 1;
        }
        InvoicePayDetails invoicePayDetails = new InvoicePayDetails();

        ResponseEntity<String> responseEntity = null;
        String URL="http://pay.restopos.in/dashdoard/getOnlinePaymentDetails";
        RestTemplate restTemplate = new RestTemplate();
        HttpHeaders headers = new HttpHeaders();
        ...
        if(responseEntity.getBody()!=null){
            ...
            String delUrl = "http://pay.restopos.in/dashdoard/inactiveOnlineInv";
            restTemplate = new RestTemplate();
            headers = new HttpHeaders();
            headers.add("Content-Type", "application/json");
            HttpEntity<String> entities = new HttpEntity<String>(invoicePayDetails.getInvoicePayId().toString(), headers);
            ...
            timelimit=0;
            t1=0;
            if(!StringUtils.equalsIgnoreCase(invoicePayDetails.getMessage(),"Success")){
             InvoiceOnline invoiceOnline = onlineRepository.findByInvoiceno(invoicePayDetails.getTransactionId());
             onlineRepository.delete(invoiceOnline);
            }
            ...
            if (System.currentTimeMillis() < t1) {
                ...
                timelimit=0;
                t1=0;
                invoicePayDetails.setMessage("Time Exceeded");
                return invoicePayDetails;
    ...
    @RequestMapping(value="/swipeMachinePayment",method = RequestMethod.POST,consumes = "application/json")
        public ResponseEntity swipePayment(@RequestParam(value = "payStatus")String paystatus,
                @RequestBody RetailDTO retailDTO)throws Exception{

        AirPayDetails airPay = new AirPayDetails();
        Company company =companyRepository.findAllByStatus("Active");
        PaymentMethod paymentMethod = paymentMethodRepository.findByPaymentmethodName("airPay");
        FormSetUp formSetUp=formSetupRepository.findAllByTypename("DirectSalesInvoice");
        int incValue = Integer.parseInt(formSetUp.getNextref());
        String ref=String.format("%05d", ++incValue);
        String no = paymentMethod.getMerchantId() + ref;//will be changed for now taken merchantid + invNo
        String response = null;
        InvoiceOnline invOl= onlineRepository.findByInvoiceno(no);
        if(StringUtils.equalsIgnoreCase("Re-Initiate",paystatus)|| invOl !=null){
            airPay = getAirPayDetails(paymentMethod.getMerchantId());
        }
        else{
            ...
            uriParams.add("orderid", paymentMethod.getMerchantId() + "_" +ref);
        ...
        if(!StringUtils.isEmpty(response)){
            ...
            responseMap = gson.fromJson(response, type1);
            if(StringUtils.equalsIgnoreCase("200.0",responseMap.get("status").toString())){
                InvoiceOnline invoiceOnline = new InvoiceOnline();
                invoiceOnline.setInvoiceno(no);
                invoiceOnline.setStatus("Success");
                onlineRepository.save(invoiceOnline);
                airPay = getAirPayDetails(paymentMethod.getMerchantId());

            }
            else if(StringUtils.equalsIgnoreCase("502.0",responseMap.get("status").toString())){
                airPay.setMessage("Fail");

            }
            else if(StringUtils.equalsIgnoreCase("500.0",responseMap.get("status").toString())){
                airPay.setMessage("Duplicate Invoice Id");

            }

        }
        AirPayDetailsPojo airPayDetailsPojo = OnlineInvoiceMapper.MapAirPayEntitytoPOJO(airPay);
        return ResponseEntity.status(200).body(airPayDetailsPojo);
    }
    public AirPayDetails getAirPayDetails(String merchantId) throws Exception{
        AirPayDetails airPayDetails = new AirPayDetails();
        airPayDetails = hiposService.getPosTransDetails(merchantId);
        System.out.println(airPayDetails+"controller");
        if(airPayDetails == null){
         Thread.sleep(30000);
         System.out.println("aaa");
         return getAirPayDetails(merchantId);
        }
    ...
    public ResponseEntity save(@RequestParam(value = "tableNo",required = false) String tableNo,
        ...
        Map<String,List<String>> cloudPrinterConfs = new HashMap();
        ...
        if(StringUtils.isEmpty(retailDTO.getMobileNo())&&customer!=null){
            retailDTO.setMobileNo(customer.getTelephone());
        }
        ...
        if(!retailDTO.isBluetoothStatus()&& !StringUtils.equalsIgnoreCase("save",printType) && posPrinterService!=null) {
            ...
            if(!StringUtils.isEmpty(retailDTO.getOlInvPayId()) || !StringUtils.isEmpty(retailDTO.getAirPayId())){
                cloudPrinterConfs = posPrinterService.formatAndPrintPayBill(retailPrintDTO);
            }
        ...
        if(!StringUtils.isEmpty(tableNo)) {
            TablesPos tablesPos = hiposService.getTablePosObj(tableNo);
            RestaurantTempData resturantTempData1 = hiposService.getRestTempDataOnId(tablesPos.getTableName(), tablesPos.getTableid().toString());
            if (!StringUtils.isEmpty(tablesPos.getMergeTable())&&resturantTempData1==null) {
                List<Long> longList = new ArrayList<>();
                Gson json = new Gson();
                Type type = new TypeToken<List<Long>>() {
                }.getType();
        ...
        multiResponse.put("CloudPaybill",cloudPrinterConfs);
    ...
    public ResponseEntity getDuplicateSIPrint(@RequestParam(value = "invoiceNo") String invoiceNo) throws ParseException {
        Gson gson = new Gson();
        AccountSetup accountSetup=accountSetupRepository.getOne(1L);
        Type type1 = new TypeToken<PrinterSelectionDisplayPojo>(){}.getType();
        PrinterSelectionDisplayPojo printerSelectionDisplayPojo = new PrinterSelectionDisplayPojo();
        printerSelectionDisplayPojo = gson.fromJson(accountSetup.getPrintDetails(),type1);
    ...
    public String cancelInvoice(@RequestBody Map<String, String> params)throws JSONException,IOException{
        ...
        if(!StringUtils.isEmpty(company.getPhone())) {
            ...
            sendSmsRestaurant.sendSmsRestaurantCancelled(String.valueOf(salesInvoice.getTotalAmount()), salesInvoice.getCustomerId().getFirstName(), company.getPhone(), salesInvoice.getSINo());
        }
    ...
    public ResponseEntity saveAgent(@RequestBody AgentPojo agentPojo)throws Exception{
    ...
    public ResponseEntity saveCustomer(@RequestBody CustomerPojo customerPojo)throws Exception{
        return ResponseEntity.status(200).body(hiposService.saveCustomer(customerPojo));
    }
    @RequestMapping(value = "/changeCredentails",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity changeCredentails(@RequestBody UserAccountSetUpDTO userAccountSetUpDTO){
        return ResponseEntity.status(200).body(hiposService.changeCredentails(userAccountSetUpDTO));
    }
...
//                                              @RequestParam(value = "searchText", required = false) String searchText,
//                                              @RequestParam(value = "pageNo", required = false) int pageNo)throws Exception {
//        return ResponseEntity.status(200).body(hiposService.getcountrypagelist(type, pageNo, searchText));
//    }
...
//                                              @RequestParam(value = "searchText", required = false) String searchText,@RequestParam(value = "pageNo")int  pageNo)throws Exception {
//        return ResponseEntity.status(200).body(hiposService.getPaginatedPaymentMethodList(type,  searchText,pageNo));
//    }
    ...
    public ResponseEntity getPaginatedShiftList(@RequestParam(value = "type", required = false) String type,
                                              @RequestParam(value = "searchText", required = false) String searchText,
                                              @RequestParam (value = "pageNo", required = false) int pageNo)throws Exception {
        return ResponseEntity.status(200).body(hiposService.getPaginatedShiftList(type, pageNo, searchText));
    }
    ...
    public ResponseEntity getPaginationCustomerList(@RequestParam(value = "type", required = false) String type,
                                                    @RequestParam(value = "searchText", required = false) String searchText,
                                                    @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception {
        return ResponseEntity.status(200).body(hiposService.getPaginationCustomerList(type, pageNo, searchText));
    }
    ...
    public ResponseEntity getPaginatedTableconfiList(@RequestParam(value = "type", required = false) String type,
        ...
        return ResponseEntity.status(200).body(hiposService.getPaginatedTableconfigList(type, searchText,pageNo));
    }
    ...
    public ResponseEntity getpaginatedtable(@RequestParam(value = "type", required = false) String type,
                                                     @RequestParam(value = "searchText", required = false) String searchText,@RequestParam(value = "pageNo")int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getpaginatedtable(type, searchText,pageNo));
    }
    ...
    public ResponseEntity getOnlineOrders(@RequestParam(value = "orderNo",required = false)String orderNo){
        ...
        for(Map obj:keyMapList){
            ...
            obj.put("customerName",customer.getFirstName());
        }
    ...
    public ResponseEntity getPaginatedItemList(@RequestParam(value = "type", required = false) String type,
                                            @RequestParam(value = "searchText", required = false) String searchText,
                                           @RequestParam(value = "pageNo")int pageNo) throws Exception {
        return ResponseEntity.status(200).body(hiposService.getPaginatedItemList(type,  searchText,pageNo));
    }
    ...
    public ResponseEntity getPaginatedEmployeeList(@RequestParam(value = "type", required = false) String type,
                                                @RequestParam(value = "searchText", required = false) String searchText,
                                                @RequestParam(value = "pageNo")int pageNo) throws Exception {
        return ResponseEntity.status(200).body(hiposService.getPaginatedEmployeeList(type, searchText,pageNo));
    }
...
//                    Category category=categoryRepository.findAllByName(itemCat.toString());
        ...
        try {
            ...
            for (int i = 1; i < sheet.getLastRowNum() + 1; i++) {
                ...
                if(row!=null) {
                    ...
                    categoryPojo.setDescription(desc==null?null:desc.toString());
        ...
        try {
            ...
            for (int i = 1; i < sheet.getLastRowNum() + 1; i++) {
                ...
                if(row!=null) {
                    ...
                    countryPojo.setCountry_name(name);
        ...
        try {
            ...
            for (int i = 1; i < sheet.getLastRowNum() + 1; i++) {
                ...
                if(row!=null) {
                    ...
                    statePojo.setCountry_name(country);
                    statePojo.setName(state);
        ...
        try {
            ...
            for (int i = 1; i < sheet.getLastRowNum() + 1; i++) {
                ...
                if(row!=null) {
                    ...
                    String status = row.getCell(3).toString();
                    tableConfigPojo.setZone_name(name);
                    tableConfigPojo.setNo_of_rows(new Double(rows.toString()).intValue());
                    tableConfigPojo.setNo_of_col(new Double(columns.toString()).intValue());
        ...
        try {
            ...
            for (int i = 1; i < sheet.getLastRowNum() + 1; i++) {
                ...
                if(row!=null) {
                    ...
                    currencyDTO.setCurrency_code(name == null ? null : name.toString());
                    currencyDTO.setCurrency_name(code == null ? null : code.toString());
                    currencyDTO.setCurrency_symbol(symbol == null ? null : symbol.toString());
                    currencyDTO.setCurrency_status("Active");
...
//                        tablesPosPojo.setTable_name(tableName == null ? null : tableName.toString());
//                        tablesPosPojo.setZone_id(configurationname == null ? null : configurationname.toString());
...
//                        tablesPosPojo.setTable_status(status == null ? null : status.toString());
...
//                    customerPojo.setCreditedLimit(CreditLimit==null?null:CreditLimit.toString());
    ...
    @RequestMapping(value = "/saveKitchen",method = RequestMethod.POST,produces = "application/json")
    public ResponseEntity saveKitchen(@RequestBody KitchenMasterPOJO kitchenMasterPOJO)throws Exception{
        return ResponseEntity.status(200).body(hiposService.saveKitchen(kitchenMasterPOJO));
    }
    @RequestMapping(value = "/getpaginatedKitchen", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity getpaginatedKitchen(@RequestParam(value = "type", required = false) String type,
                                              @RequestParam(value = "searchText", required = false) String searchText,
                                              @RequestParam(value = "pageNo",required = false)int pageNo) throws Exception{
        return ResponseEntity.status(200).body(hiposService.getKitchenpagelist(type, searchText,pageNo));
    }
    ...
    public ResponseEntity itemExport(@RequestParam(value = "type")String type) throws IOException {
        HttpHeaders headers = new HttpHeaders();
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        if(StringUtils.equalsIgnoreCase(type,"Pdf")){
            reportService.downloadItemPdf(outputStream);
            headers.add("Content-Disposition", "attachment; filename=\"" + "item.pdf" + "\"");
        }
        else if(StringUtils.equalsIgnoreCase(type,"Excel")){
            reportService.writeItemstoExcel(outputStream);
